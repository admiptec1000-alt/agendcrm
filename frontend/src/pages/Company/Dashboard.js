            ...
            <div key={a.id} className={`rounded-xl border bg-white overflow-hidden ${isCancelled ? 'opacity-60' : ''}`} data-testid={`agenda-item-${a.id}`}>
              <div className="flex items-stretch">
                ...
                <div className="flex-1 px-3 py-3 min-w-0">
                  ...
                  <p className="text-[11px] text-slate-500 truncate leading-snug mt-0.5">{a.service_name} &middot; {a.professional_name} &middot; R$ {(a.price||0).toFixed(2)}</p>
                ...
                <div className="flex items-center px-2 flex-shrink-0">
                  ...
                  {a.status === 'confirmado' && (
                    <button onClick={() => setConcludeApt(a)}
                  ...
                  {!isCancelled && !isDone && (
                    <button onClick={() => handleStatusChange(a.id, 'cancelado')}
                      className="p-1.5 rounded-lg text-slate-400 hover:text-red-500 hover:bg-red-50 ml-1"
